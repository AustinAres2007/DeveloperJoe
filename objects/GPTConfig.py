...
ALLOWED_INTERACTIONS = [ChannelType.private_thread, ChannelType.text, TextChannel] # What text channels the bot is allowed to talk in. Even if modifying source code, I do NOT recommend changing this.