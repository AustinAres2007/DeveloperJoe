...
class ReadbleBooleanTransformer(discord.app_commands.Transformer):
    async def autocomplete(self, interaction: discord.Interaction[discord.Client], value: int | float | str) -> List[Choice[str | int | float]]:
        return [Choice(name="Yes", value=True), Choice(name="No", value=False)]
...
BooleanChoices = discord.app_commands.Transform[bool, ReadbleBooleanTransformer]